...
**Tanimoto coefficient** — intersection over union. Used to measure overap between mutipe-choice answers, in object recognion, for binary molecular fingerprints (where bits represent presence/absence of a substructure:
