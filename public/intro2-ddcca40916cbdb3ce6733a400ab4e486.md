...
# Anscombe's Quartet - Dataset I (linear) vs II (curved)
x  = np.array([10, 8, 13, 9, 11, 14, 6, 4, 12, 7, 5])
y1 = np.array([8.04, 6.95, 7.58, 8.81, 8.33, 9.96, 7.24, 4.26, 10.84, 4.82, 5.68])  # linear
y2 = np.array([9.14, 8.14, 8.74, 8.77, 9.26, 8.10, 6.13, 3.10,  9.13, 7.26, 4.74])  # curved

fig, axes = plt.subplots(1, 2, figsize=(10, 4))
for ax, y, label in zip(axes, [y1, y2], ['I — Linear', 'II — Curved']):
