...
For vectors representing data (sparse document-term frequencies, dense embeddings of text, images, and audio...), we define cosine similarity:
...
**Intersection over Union (Tanimoto coefficient)** (binary variant):
