...
emails = {
    "spam1": "buy cheap meds free offer click",
    "spam2": "free prize win offer click now",
    "ham1":  "meeting agenda report attached",
    "ham2":  "send report meeting tomorrow",
}

# Build vocabulary and count vectors
...
print(f"{'Pair':<20} {'Cosine':>6}")
print("-" * 28)
for a, b in pairs:
    print(f"{a} vs {b:<8} {cosine(vecs[a], vecs[b]):>6.3f}")

print(f"\nVocabulary: {vocab}")
print(f"\nspam1 vector: {vecs['spam1']}")
print(f"spam2 vector: {vecs['spam2']}")
```
